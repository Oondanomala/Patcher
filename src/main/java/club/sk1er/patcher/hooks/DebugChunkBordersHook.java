...
public class DebugChunkBordersHook {
    ...
    public static void render(float partialTicks) {
        ...
        for (int k = 2; k < 16; k += 2) {
            ...
            worldRenderer.pos(d5 + k, d3, d6 + 16).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
            worldRenderer.pos(d5 + k, d3, d6 + 16).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + k, d4, d6 + 16).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + k, d4, d6 + 16).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
        }
        ...
        for (int l = 2; l < 16; l += 2) {
            ...
            worldRenderer.pos(d5 + 16, d3, d6 + l).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
            worldRenderer.pos(d5 + 16, d3, d6 + l).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + 16, d4, d6 + l).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + 16, d4, d6 + l).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
        }
        ...
        for (int i1 = 0; i1 <= 256; i1 += 2) {
            ...
            worldRenderer.pos(d5, d7, d6 + 16).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + 16, d7, d6 + 16.0D).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + 16, d7, d6).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5, d7, d6).color(1.0F, 1.0F, 0.0F, 1.0F).endVertex();
            worldRenderer.pos(d5, d7, d6).color(1.0F, 1.0F, 0.0F, 0.0F).endVertex();
        }
        ...
        for (int k1 = 0; k1 <= 256; k1 += 16) {
            ...
            worldRenderer.pos(d5, d8, d6 + 16).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + 16, d8, d6 + 16).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
            worldRenderer.pos(d5 + 16, d8, d6).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
            worldRenderer.pos(d5, d8, d6).color(0.25F, 0.25F, 1.0F, 1.0F).endVertex();
            worldRenderer.pos(d5, d8, d6).color(0.25F, 0.25F, 1.0F, 0.0F).endVertex();
        }
